...
{
    //This are the public variables for speed. They can be changed in the inspector in the unity
    //window.
    ...
    //For physics it is best practice to use Fixed update rather than update as it is more reliable to
    //due to being done at a fixed time, meaning lag or graphical strain won’t affect physics
    //calculations
private void FixedUpdate()
    {
        ...
        //MAKE SURE THE FRONT OF YOUR ROVER IS LINED UP WITH THE X AXIS OF THE
        //MOON ROVER GAME OBJECT THE MODEL IS A CHILD OF
        //This applies a force on the rigidbody in the x dimension relative to its forward direction
        
        rb.AddRelativeForce(-forwardMoveAmount, 0, 0);
    }
}